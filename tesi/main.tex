...
\begin{document}
	% Frontespizio
	\input{otherResources/frontespizio}	
	\pagenumbering{roman}
	% Dedica e/o frase in prima di copertina
	 \input{otherResources/frase}
	\myemptypage %Deve essere eseguita anche se commentata
	% Indice: 
	\newpage
	\tableofcontents
	% Introduzione
	...
	% Appendici
    	\input{capitoli/appendici/appendice1.tex}
	% ...	
	% Bibliogragia
	\input{otherResources/noCiteBibliografia.tex}
	...
	% Ringraziamenti 
    \input{otherResources/ringraziamenti.tex}
\end{document}
